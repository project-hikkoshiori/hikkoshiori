...
class PropertyDB(Base):
    ...
    monthly_maintenance_fee = sqlalchemy.Column(
        "monthly_maintenance_fee", sqlalchemy.Integer
    )
    ...
    additional_info = sqlalchemy.Column(
        "additional_info", sqlalchemy.dialects.postgresql.JSONB
    )
